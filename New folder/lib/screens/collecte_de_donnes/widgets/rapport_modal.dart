              ...
              builder: (context, constraints) {
                ...
                return TabBar(
                  ...
                  tabs: [
                    Tab(
                      icon:
                          Icon(Icons.analytics, size: isSmallScreen ? 18 : 24),
                      child: Text(
                        isSmallScreen
                            ? 'Rapport\nStats'
                        ...
                        style: TextStyle(
                          ...
                          height: isSmallScreen ? 1.1 : 1.0,
                        ),
                      ),
                    ),
                    Tab(
                      icon: Icon(Icons.receipt, size: isSmallScreen ? 18 : 24),
                      child: Text(
                        isSmallScreen ? 'Reçu\nCollecte' : 'Reçu de Collecte',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: isSmallScreen ? 10 : 14,
                          height: isSmallScreen ? 1.1 : 1.0,
        ...
        children: [
          LayoutBuilder(
            builder: (context, constraints) {
              ...
              if (isSmallScreen) {
                // Sur petits écrans : disposition verticale et titre plus court
                return Column(
                  children: [
                    const Icon(
                      Icons.analytics,
                ...
                // Sur écrans normaux : disposition horizontale normale
                return Row(
