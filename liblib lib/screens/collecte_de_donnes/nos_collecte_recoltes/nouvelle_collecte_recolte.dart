...
// --- Responsive font util ---
double adaptiveFont(BuildContext context, double base,
    {double minFactor = 0.82, double breakpoint = 420}) {
  final w = MediaQuery.of(context).size.width;
  if (w >= breakpoint) return base;
  final factor = (w / breakpoint).clamp(minFactor, 1.0);
  return (base * factor); // arrondir implicitement
}
                    ...
                    if (selectedCommune != null) ...[
                      ...
                      LayoutBuilder(
                        builder: (context, constraints) {
                          ...
                          if (isSmallScreen) {
                            // Sur petits écrans : disposition verticale
                            return Column(
                              children: [
                                RadioListTile<bool>(
                                  title: Builder(
