...
class UserListWidget extends StatelessWidget {
  ...
  Widget _buildDesktopTable() {
    ...
    // IMPORTANT: Pas de Expanded ici car le parent (SliverToBoxAdapter) fournit
    // une hauteur non bornée. On laisse la colonne se dimensionner (shrink-wrap)
    // et le scroll vertical est géré par le CustomScrollView parent.
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
