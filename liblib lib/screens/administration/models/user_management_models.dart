...
extension UserActionTypeExtension on UserActionType {
  ...
  /// Indique si l'action est irréversible d'un point de vue métier.
  bool get isIrreversible {
    switch (this) {
      case UserActionType.deleted:
      case UserActionType
            .passwordGenerated: // mot de passe affiché 1 seule fois
        return true;
      default:
        return false;
    }
  ...
  /// Indique si l'action peut être annulée ou compensée (ex: re-activation, re-changement rôle)
  bool get isReversible => !isIrreversible;
}
