              ...
              child: pw.Column(
                children: [
                  pw.Row(
                    ...
                    children: [
                      _buildMetricCard(
                          'Total Attributions', '${stats.totalAttributions}'),
                      _buildMetricCard(
                          'Lots Concernés', '${stats.nombreLotsUniques}'),
                      _buildMetricCard(
                          'Commerciaux Actifs', '${stats.nombreCommerciaux}'),
                    ],
                  ),
                  ...
                  pw.Row(
                    ...
                    children: [
                      _buildMetricCard(
                          'Quantité Totale', '${stats.quantiteTotale}'),
                      _buildMetricCard('Valeur Moyenne',
                ...
                children: [
                  pw.Row(
                    ...
                    children: [
                      ...
                      _buildMetricCard(
                          'Clients Uniques', '${stats.nombreClientsUniques}'),
                      _buildMetricCard(
                          'Commerciaux Actifs', '${stats.nombreCommerciaux}'),
                    ],
                  ),
                  ...
                  pw.Row(
                    mainAxisAlignment: pw.MainAxisAlignment.spaceAround,
                    children: [
                      _buildMetricCard('Panier Moyen',
                          '${stats.panierMoyen.toStringAsFixed(0)} FCFA'),
                      _buildMetricCard('Taux Crédit',
