      ...
      return Column(
        children: [
          _buildSettingsCard(
            ...
            children: [
              Text(
                'Définissez la référence tarifaire et la devise utilisées par défaut\n'
                'pour les calculs rapides lorsque aucune prédominance spécifique n\'est sélectionnée.',
                style: TextStyle(
              ...
              const SizedBox(height: 16),
              _buildNumberField(
                label: 'Prix de base du miel (FCFA/kg)',
